...
theme_set(
  theme_bw() + 
    theme(plot.background = element_rect(fill = "#f0df8b", color = "#f0df8b"),
...
<div style="font-size:0.3em"><br>3 November 2025</div>
</div>
...
ggplot(dat) + 
  ...
  geom_point(aes(x = 0, y = -Year), size = 14, fill = "#f0df8b", shape = 21) +
  ...
  theme_nothing() +
  xlim(0,20) +
  theme(panel.background = element_rect(fill = "#f0df8b", color = NA),
        plot.background = element_rect(fill = "#f0df8b", color = NA))
```
</div>
